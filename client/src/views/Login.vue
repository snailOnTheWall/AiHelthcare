<template>
        <div class="max-w-md mx-auto mt-20 bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
          <div class="md:flex">
            <div class="p-8">
              <div class="uppercase tracking-wide text-sm text-indigo-500 font-semibold">Member Login</div>
              <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Access Your Account</a>
              <p class="mt-2 text-gray-500">Enter your credentials to access your dashboard.</p>
              <form class="mt-4">
                <div class="mb-4">
